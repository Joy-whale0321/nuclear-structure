...
for EQMD_struct1 in {1..5}; do
    ...
    for EQMD_struct2 in $(seq $EQMD_struct1 5); do
        hadd /sphenix/user/jzhang1/nuclear-structure/output/method2/NeEQMD/NeNe_EQMD${EQMD_struct1}${EQMD_struct2}_method2_100k.root /sphenix/user/jzhang1/nuclear-structure/output/method2/NeEQMD/NeNe_EQMD${EQMD_struct1}${EQMD_struct2}_run*root
